...
The GIF below shows a real interactive `codex` session reading this skill and calling the bundled 12306 client.
...
```text
Use the china-railway-12306 skill to find G1 stops on 2026-05-20.
Return the train_no and the stop list.
```
...
```text
Use this repository's china-railway-12306 skill to query G1 stops on 2026-05-20.
Return only train_no and the stop list. Do not modify files.
```
